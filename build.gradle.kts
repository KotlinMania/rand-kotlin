...
kotlin {
    ...
    val xcf = XCFramework("Rand")

    macosArm64 {
        binaries.framework { baseName = "Rand"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework {
            baseName = "Rand"
    ...
    swiftExport {
        moduleName = "Rand"
        flattenPackage = "io.github.kotlinmania.rand"
    }

    android {
        namespace = "io.github.kotlinmania.rand"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "rand-kotlin", version.toString())

    pom {
        name.set("rand-kotlin")
        description.set("Kotlin Multiplatform port of rust-random/rand - Random number generators and other randomness functionality")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/rand-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/rand-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/rand-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/rand-kotlin.git")
        }
    }
}
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleRandXCFramework",
    "assembleRandDebugXCFramework",
    "assembleRandReleaseXCFramework",
    "assembleDebugIosFatFrameworkForRandXCFramework",
    "assembleReleaseIosFatFrameworkForRandXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForRandXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForRandXCFramework",
    "assembleDebugMacosFatFrameworkForRandXCFramework",
    "assembleReleaseMacosFatFrameworkForRandXCFramework",
    "assembleDebugTvosFatFrameworkForRandXCFramework",
    "assembleReleaseTvosFatFrameworkForRandXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForRandXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForRandXCFramework",
    "assembleDebugWatchosFatFrameworkForRandXCFramework",
    "assembleReleaseWatchosFatFrameworkForRandXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForRandXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForRandXCFramework",
