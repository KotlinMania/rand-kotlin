...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `Rand.swiftmodule/`
...
//      `import Rand` above would fail at compile time.
//
//   2. The static archive `libRand.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "Rand" }` and
//      `flattenPackage = "io.github.kotlinmania.rand"` configuration in
...
final class RandExportTests: XCTestCase {
    func testSwiftModuleLoads() throws {
        XCTAssertTrue(true, "Rand swift module imported cleanly")
    }
}
