...
This file is the quick-reference operating contract for rand-kotlin. The longer
...
rand-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`rand`](https://crates.io/crates/rand). Upstream Rust is the behavioral oracle while the
